...
const Carousel: React.FC = () => {
    ...
    return (
        <div className="carousel mb-[50px] md:mb-[100px] text-[#fff]">
            <div
            ...
            >
                ...
                <div className="flex flex-row justify-between items-center mt-[50px] md:mt-[150px] px-5 md:px-[100px] pt-[150px ">
