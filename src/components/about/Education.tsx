...
const Education = () => {
  return (
    <div className="px-5 md:px-[100px] pt-[50px] md:pt-[100px]">
                    ...
                    <div>
                        <div className="flex flex-row gap-5 items-center">
                            ...
                            <div>
                                ...
                                <p>{item.school}</p>
                                <p className="flex flex-row flex-wrap md:flex-nowrap font-semibold">Course Content: {item.courseContent.map((item)=> (
        ...
        <Link to="https://www.linkedin.com/in/kingsley-ibe/details/certifications/" target="__blank" className="text-[20px] md:text-[35px] mb-[100px] line hover:opacity-[0.6]">See More Certifications → </Link>
    </div>
  )
};
